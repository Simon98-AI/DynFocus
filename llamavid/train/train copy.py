...
class LazySupervisedDataset(Dataset):
    ...
    def __init__(self, data_path: str,
        ...
        bad_cnt=0
        # for sample in list_data_dict: # use only the video data
        #     if 'image' in sample:
        #         list_data_dict_video.append(sample)
        # self.list_data_dict = list_data_dict_video
        self.list_data_dict = list_data_dict
    ...
    def read_image_data(self, file_name):
        goal_idx = file_name['image'].rfind('/')
        class_ = file_name['image'][0:goal_idx]
        goal_file = file_name['image'][goal_idx+1:]
        # 判断是哪一种数据集
        if class_ == "coco/train2017":
            ...
            # data_dir2 = "/mnt_new/songkaiyou.sky/datasets/ocr_vqa/images/images2"
            data_file = data_dir + goal_file 
            # data_file2 = data_dir2 + goal_file 
            # 判断是否存在
            # if os.path.exists(data_file1):
            #     image = Image.open(data_file1).convert('RGB')    
            # else: 
            #     image = Image.open(data_file2).convert('RGB')   
        ...
        while attempt < max_attempt:
            try:
                ...
                if 'image' in sources[0]:
                    ...
                    file_name = self.list_data_dict[i]
                    root_name = self.read_image_data(file_name)
                    # file_name = self.list_data_dict[i]['image']
            ...
            # 这里数据没有读进来
                ...
                print("Problem: ", self.list_data_dict[i], "!!!!!!!!")
